...
public class ParallaxNewsfeedAdapter extends BaseAdapter implements Swappable,
        OnClickListener {
    ...
    public ParallaxNewsfeedAdapter(Context context,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(
                    R.layout.list_item_parallax_newsfeed, parent, false);
